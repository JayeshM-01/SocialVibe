...
export const Sidebar = () => {
  ...
  return (
    <div>
<div className="text-center flex flex-start p-5">
  <button
    type="button"
  ...
  >
    <img 
      src={artImage} 
      alt="Art" 
      className="h-[10vh] w-[10vh]" // Adjust the height and width values as needed
    />
  </button>
</div>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <a href="/fileupload" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Upload</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="/reels" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li>
                    <a href="/friends" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
